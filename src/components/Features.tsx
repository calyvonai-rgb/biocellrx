    ...
    <section id="about" className="py-20 bg-medical-light">
      <div className="container mx-auto px-6">
        ...
        <div className="relative">
          ...
          {/* Why Choose BioCellRx Image with Text Overlay */}
          <div className="max-w-6xl mx-auto relative group">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-20">
                <div className="text-center bg-black/30 backdrop-blur-sm rounded-xl p-6 max-w-2xl mx-4">
                  <h3 className="text-2xl md:text-3xl font-bold mb-4 text-white">
                    Why Choose BioCellRx?
                  </h3>
                  <p className="text-lg text-white/90 leading-relaxed">
                    Our innovative stem cell therapy process is designed to harness your body's natural healing potential. From consultation to recovery, we guide you through each step with personalized care and cutting-edge science.
                  </p>
                </div>
              </div>
            </div>
