    ...
    <div className="w-full" ref={videoRef}>
      <div style={{padding:"75% 0 0 0", position:"relative"}} className="video-container">
        {isVideoVisible ? (
          <iframe 
            ref={iframeRef}
            src="https://player.vimeo.com/video/1117754950?badge=0&autopause=0&player_id=0&app_id=58479&title=0&byline=0&portrait=0&controls=1&autoplay=1&muted=0&playsinline=1"
            frameBorder="0" 
